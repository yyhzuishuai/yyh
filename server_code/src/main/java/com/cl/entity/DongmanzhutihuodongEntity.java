...
public class DongmanzhutihuodongEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DongmanzhutihuodongEntity() {
		
	}
	
	public DongmanzhutihuodongEntity(T t) {
		try {
	 ...
	 * 设置：参加形式
	 */
	public void setCanjiaxingshi(String canjiaxingshi) {
		this.canjiaxingshi = canjiaxingshi;
	}
	/**
	 * 获取：参加形式
	 */
	public String getCanjiaxingshi() {
		return canjiaxingshi;
	}
	/**
	 * 设置：开始时间
	 */
