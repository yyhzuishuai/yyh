				...
				<el-row >
					...
					<el-col :span="12">
						<el-form-item label="充值金额" prop="amount">
							<el-input class="list_inp" v-model.number="form.amount" placeholder="充值金额"
                                type="number"
                                @mousewheel.native.prevent
								:readonly="!isAdd||disabledForm.amount?true:false" />
						</el-form-item>
					</el-col>

					<el-col v-if="!isAdd" :span="12">
						<el-form-item label="充值时间" prop="addtime">
							<el-input class="list_inp" v-model="form.addtime" placeholder="${column.comments}" readonly type="text" />
						</el-form-item>
					</el-col>
