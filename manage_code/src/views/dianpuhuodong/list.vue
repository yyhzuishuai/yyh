		...
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('dianpuhuodong','删除')">
						删除
					</el-button>
				</div>
			</div>
			<el-table
				...
				<el-table-column label="操作" class-name="operation-cell" width="300" fixed="right" :resizable='true' :sortable='false' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('dianpuhuodong','查看')" @click="infoClick(scope.row.id)">
							详情
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('dianpuhuodong','修改')">
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('dianpuhuodong','删除')">
							删除						</el-button>
					</template>
				</el-table-column>
			</el-table>
