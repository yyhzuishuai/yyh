	...
	<div class="detail-page">
		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">充值金额</div>

					<div  class="info_text" >{{detail.amount}}</div>
				</div>
                <div class="info_item">
                    <div class="info_label">充值时间</div>
                    <div class="info_text">{{detail.addtime}}</div>
                </div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('recharge_record','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('recharge_record','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
