		...
		<div class="detail_view">
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.fulladdress}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">营业资质</div>
					<div class="info_text">
						<el-button class="info_down" v-if="detail.yingyezizhi" @click="downClick(detail.yingyezizhi)">点击下载</el-button>
				...
				<div class="btn_view">
					...
					<el-button class="approval_btn" v-if="btnAuth('shangjia','审核')&&detail.sfsh=='待审核'" type="warning" @click="approvalClick()">审核</el-button>
