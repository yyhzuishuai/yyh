			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.dingdanbianhao}}</span>
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">周边名称</div>

					<div  class="info_text" >{{detail.zhoubianmingcheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">周边类型</div>

					<div  class="info_text" >{{detail.zhoubianleixing}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">颜色</div>

					<div  class="info_text" >{{detail.yanse}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">尺寸</div>

					<div  class="info_text" >{{detail.chicun}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">材质</div>

					<div  class="info_text" >{{detail.caizhi}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('dingzhidingdan','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('dingzhidingdan','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('dingzhidingdan','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="设计描述" name="first">
				<div v-html="detail.shejimiaoshu"></div>
			</el-tab-pane>
		</el-tabs>
