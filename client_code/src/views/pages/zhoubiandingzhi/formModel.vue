			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.shangjiamingcheng}}</span>
					</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">定制价格</div>

					<div  class="info_text" >{{detail.dingzhijiage}}</div>
				</div>
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('zhoubiandingzhi','定制周边')" @click="dingzhidingdanonAcross('定制周边','','','','')" type="warning">定制周边</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('zhoubiandingzhi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('zhoubiandingzhi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="定制介绍" name="first">
				<div v-html="detail.dingzhijieshao"></div>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
